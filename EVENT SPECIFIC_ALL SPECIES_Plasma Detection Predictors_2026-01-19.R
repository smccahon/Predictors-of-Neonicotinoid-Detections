...
# separate by sampling event
s2022 <- subset(birds, Event == "Spring 2022") # n = 29 birds
f2021 <- subset(birds, Event == "Fall 2021") # n = 26 birds
f2023 <- subset(birds, Event == "Fall 2023") # n = 79 birds
s2023 <- subset(birds, Event == "Spring 2023") # n = 31
...
s2022$DominantCrop <- relevel(birds.cs$DominantCrop,
                                 ref = "Grassland")
